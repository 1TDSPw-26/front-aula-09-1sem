...
console.log(typeof parseFloat("12.5")); // number
...
console.log(frase.substring(frase.indexOf("as"), (frase.length))); // “as provas”

console.log(frase.substring(15, 24)); // “as provas”
